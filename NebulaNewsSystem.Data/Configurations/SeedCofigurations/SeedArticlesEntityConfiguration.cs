...
namespace NebulaNewsSystem.Data.Configurations.SeedCofiguration
{
    public class SeedArticlesEntityConfiguration : IEntityTypeConfiguration<Article>
    {
        ...
        private Article[] GenerateArticles()
        {
            ...
            article = new Article()
            {
                Id = Guid.Parse("550f78bf-9c45-4fa1-9a1e-4af3a5192be6"),
            ...
            article = new Article()
            {
                Id = Guid.Parse("49cde94c-3f90-4f95-8e91-a751aa2b7af4"),
            ...
            article = new Article()
            {
                Id = Guid.Parse("3c74cdaa-71b0-4789-89e0-93c72fd2e8a9"),
